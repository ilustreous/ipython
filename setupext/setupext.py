...
def check_for_zopeinterface():
    try:
        ...
        print_status("zope.Interface", "Not found (required for legacy (IPython.kernel) parallel computing capabilities)")
        return False
    else:
...
def check_for_twisted():
    try:
        ...
        print_status("Twisted", "Not found (required for legacy (IPython.kernel) parallel computing capabilities)")
        return False
    else:
        ...
        if not ((major==2 and minor>=5 and micro>=0) or \
            ...
            print_message("Twisted is required for legacy (IPython.kernel) parallel computing capabilities")
            return False
        else:
            return True
...
def check_for_foolscap():
    try:
        ...
        print_status('Foolscap', "Not found (required for legacy (IPython.kernel) parallel computing capabilities)")
        return False
    else:
...
def check_for_pyopenssl():
    try:
        ...
        print_status('OpenSSL', "Not found (required if you want security in the legacy (IPython.kernel) parallel computing capabilities)")
        return False
    else:
